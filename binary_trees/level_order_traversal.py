...
#     def traverse_right(root, depth, final_list):
#         if not root:
#             return final_list
...
#         # if root.right:
#         traverse_right(root.right, depth + 1, final_list)
#         if not root.right:
#             traverse_right(root.left, depth + 1, final_list)

#         return final_list
    
#     return traverse_right(root, 0, final_list)
...
print(levelOrder(root=root_node))